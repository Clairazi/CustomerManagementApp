 ...
 * Displays a list of products with filtering, search, and action buttons
 */
function ProductList({ onAddNew, onEdit, onDeleteSuccess, refreshTrigger }) {
  // State management
  ...
  /**
   * Effect hook to load products on component mount and when filters change
   */
  useEffect(() => {
    loadProducts();
  }, [refreshTrigger]);
  ...
  const handleExport = async () => {
    try {
      setError(null);
      await productService.exportProductsToExcel(filters);
      ...
      <Card>
        <Card.Body>
          {loading ? (
            ...
            <Alert variant="info">
              No products found. {filters.name 
